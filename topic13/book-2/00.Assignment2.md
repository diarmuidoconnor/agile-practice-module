## Agile Software Practice - Assignment 2 (Outline).
...
__Independent Learning (85%+):__ Deployment of the production app to the [Vervel][vercel] platform (instead of the EC2 platform)
